...
void construct_instance(LPMP::asymmetric_multiway_cut_instance& instance, const Eigen::Array<std::size_t, Eigen::Dynamic, 2>& edge_indices, const Eigen::Array<double, Eigen::Dynamic, 1>& edge_costs, const py::array_t<double> node_costs, const py::array_t<bool> partitionable)
{
...
py::array_t<char> get_edge_mask(const LPMP::asymmetric_multiway_cut_instance& instance, const LPMP::asymmetric_multiway_cut_labeling& labeling)
{
    ...
    return py::array({pybind11::sstd::size_t(instance.nr_edges())}, edge_mask); 
} 
...
py::array_t<char> get_label_mask(const LPMP::asymmetric_multiway_cut_instance& instance, const LPMP::asymmetric_multiway_cut_labeling& labeling)
{
    ...
    return py::array({pybind11::sstd::size_t(instance.nr_nodes()), pybind11::sstd::size_t(instance.nr_labels())}, label_mask); 
} 
...
py::array_t<int> get_cc_ids_mask(const LPMP::asymmetric_multiway_cut_instance& instance, const LPMP::asymmetric_multiway_cut_labeling& labeling)
{
    ...
    return py::array({pybind11::sstd::size_t(instance.nr_nodes())}, cc_mask); 
} 
...
PYBIND11_MODULE(asymmetric_multiway_cut_py, m) {
    ...
    py::class_<LPMP::asymmetric_multiway_cut_instance>(m, "asymmetric_multiway_cut_instance")
        .def(py::init<>())
        .def(py::init([](const Eigen::Array<std::size_t, Eigen::Dynamic, 2>& edge_indices, const Eigen::Array<double, Eigen::Dynamic, 1>& edge_costs, const py::array_t<double> node_costs, const py::array_t<bool> partitionable) {
